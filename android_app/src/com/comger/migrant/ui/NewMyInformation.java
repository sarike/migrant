...
public class NewMyInformation extends BaseActivity implements OnItemClickListener {
			...
			public void onRefresh(int page_index, int page_size) {
				AsyncRunner.run(new BaseRequestListener() {
					...
					public void onRequesting() throws AppException, JSONException {
						...
						informationAdapter = new InformationAdapter(NewMyInformation.this, mJsonArray);
