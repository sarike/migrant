...
public class MyCityReportActivity extends BaseActivity{
			...
			public void onRefresh(int page_index, int page_size) {
				AsyncRunner.run(new BaseRequestListener() {
					...
					public void onRequesting() throws AppException, JSONException {
						mJsonArray = MigrantApi.getCityReporthomeList();
						informationAdapter = new InformationAdapter(MyCityReportActivity.this, mJsonArray);
