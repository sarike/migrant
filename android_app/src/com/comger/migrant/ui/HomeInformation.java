 ...
 * All right reserved
 * 
 * Created on 2013-7-29 上午9:37:05
 * 
 * @author zxy
 */
...
public class HomeInformation extends BaseActivity implements OnItemClickListener {
			...
			public void onRefresh(int page_index, int page_size) {
				AsyncRunner.run(new BaseRequestListener() {
					...
					public void onRequesting() throws AppException, JSONException {
						mJsonArray = MigrantApi.getHomeInformation();
						informationAdapter = new InformationAdapter(HomeInformation.this, mJsonArray);
